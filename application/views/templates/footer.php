    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<?php echo base_url() ?>assets_yutama/libs/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="<?php echo base_url() ?>assets_yutama/libs/popper.js/dist/umd/popper.min.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/libs/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- apps -->
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/app.min.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/app.init.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/app-style-switcher.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="<?php echo base_url() ?>assets_yutama/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/feather.min.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <!-- chartist chart -->
    <script src="<?php echo base_url() ?>assets_yutama/libs/chartist/dist/chartist.min.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js"></script>
    <!--c3 JavaScript -->
    <script src="<?php echo base_url() ?>assets_yutama/libs/d3/dist/d3.min.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/libs/c3/c3.min.js"></script>
    <!-- Chart JS -->
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/pages/dashboards/dashboard2.js"></script>
    <!-- Datatable -->
    <script src="<?php echo base_url() ?>assets_yutama/libs/datatables/media/js/jquery.dataTables.min.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/pages/datatable/custom-datatable.js"></script>
    <script src="<?php echo base_url() ?>assets_yutama/dist_yutama/js/pages/datatable/datatable-api.init.js"></script>
